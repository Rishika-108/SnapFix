...
const AdminNotificationDropdown = () => {
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            {isOpen && (
                <div className="absolute right-0 mt-3 w-[85vw] max-w-[320px] sm:w-80 bg-[#142E4D] border border-white/10 rounded-xl shadow-lg z-50 overflow-hidden animate-fadeIn">
